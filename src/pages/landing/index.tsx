...
import landingPageDesktop from '../../../public/assets/images/V2Images/landingPageDesktop.webp';
import landingPageMobile from '../../../public/assets/images/V2Images/landingPageMobile.webp';
  ...
  return (
    <MainLayout>
      <IntroductionWithImage
        deskTopImage={landingPageDesktop}
        mobileImage={landingPageMobile}
        handleGetStartedOpen={handleGetStartedOpen}
        isSuccess={isSuccess}
        title={'We plan, \nyou travel'}
        description="Plannet is your personal travel concierge. We curate, text and book the best itinerary for your next trip"
      />
      <TextToPlannet
        handleGetStartedOpen={handleGetStartedOpen}
