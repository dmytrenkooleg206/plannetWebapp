...
export default function GuestLoadingContent({ tripData }: any) {
  const { planner, tripLegs } = tripData;
            ...
            planner && (
              <>
                ...
                <p className="text-[20px]">
                  Your trip to{' '}
                  <span className="font-bold">{tripLegs[0]?.City?.name}</span>{' '}
