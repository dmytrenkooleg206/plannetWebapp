...
import PaymentCard from '../../../Summary/FreezePrice/PaymentCard';
import PlannetPaymentComplete from './PlannetPaymentComplete';
import PromoCodeScreen from './PromoCodeScreen';
import LoadingAfterDateChange from '../../../Summary/GuestTrip/LoadingAfterDateChange';
          ...
          <>
            {!paymentComplete ? (
              <div className="bg-[#1F133E] text-white p-4 min-h-[100dvh]">
                ...
                {isCFAR && (
                  <div
                    className="bg-[#7440F566] bg-white p-2 rounded-lg flex flex-start gap-2 mt-1"
